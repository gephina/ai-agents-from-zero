...
> **LangChain = 用代码把大模型和外部世界连接起来的应用开发框架。**
...
很多初学者第一次接触 LangChain 时，都会问一句：**“我不是已经会用 Coze 或 Dify 了吗，为什么还要学这个？”**
...
所以更准确的说法是：**LangChain 非常适合做 AI 应用，但要用“工程框架”的心态去学，不要把它当成一个简单工具函数库。**

### 1.7 扩展：LangChain4J 简介

如果你的技术栈主要是 Java，可以了解 **LangChain4J**。它可以理解为“Java 生态里的 LangChain 风格框架”，常与 Spring Boot、Spring AI、企业中台场景搭配使用，适合 Java 团队把 LLM、RAG、Tools、Agent 等能力整合进现有系统。
...
现在官方已经不只是在讲一个 `langchain` 包，而是在讲一整套产品线。对于初学者来说，最重要的是把这几个名字区分开：
...
**本套教程的主线仍然是：LangChain → LangGraph → MCP / 多智能体。**  
这条路线对初学者更友好，因为你先掌握基础抽象，再进入图编排，知识是连贯的。
...
Model I/O 可以理解为“**围绕模型调用本身的一圈能力**”。它解决的是：**输入怎么组织、模型怎么调、输出怎么拿得稳。**
...
这一块在真实项目里非常重要。因为 AI 应用最难排查的问题，通常不是“程序报错”，而是：
...
虽然官方当前文档导航不再严格使用老版本那种“六大模块总图”来组织内容，但对初学者来说，这套图依然非常适合建立整体认知，因此本教程继续保留这套视图。
