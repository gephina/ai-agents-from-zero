...
**对应章节：**[1-1 大模型基础认知与工程概览 §1、认识大模型](1-1-大模型基础认知与工程概览.md#_1、认识大模型)；[11 Model I/O 与模型接入 §2、LangChain 模型分类、参数与返回](11-Model-I-O与模型接入.md#_2、langchain-模型分类、参数与返回)
...
**对应章节：**[1-1 大模型基础认知与工程概览 §4、大模型的工程实现（概览）](1-1-大模型基础认知与工程概览.md#_4、大模型的工程实现%EF%BC%88概览%EF%BC%89)；[8 企业级大模型部署 §1、企业级大模型部署概述](8-企业级大模型部署.md#_1、企业级大模型部署概述)
...
**对应章节：**[19 RAG检索增强生成 §1、RAG 简介](19-RAG检索增强生成.md#_1、rag-简介)；[1-1 大模型基础认知与工程概览 §1、认识大模型](1-1-大模型基础认知与工程概览.md#_1、认识大模型)
...
可以先下一个定义：向量数据库是一种专门面向“相似度检索”的存储系统，用来保存向量、原始内容和元数据，并支持近邻搜索、过滤和召回。
